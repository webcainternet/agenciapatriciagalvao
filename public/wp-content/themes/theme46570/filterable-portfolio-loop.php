		...
		<div class="portfolio_item_holder">
			...
			<div class="caption caption__portfolio">
				...
				<?php if($folio_excerpt == "yes"){ ?>
					<span class="excerpt"><?php $excerpt = get_the_excerpt(); echo my_string_limit_words($excerpt,$folio_excerpt_count);?></span>
				<?php } ?>
				
				<?php if($folio_btn == "yes"){ ?>
					<a href="<?php the_permalink() ?>" class="btn btn-link btn-normal"><?php _e("Leia mais...", CURRENT_THEME); ?></a>
				<?php } ?>
			</div><!-- /Caption -->
		</div>
	</li>	

				...
				$output .= '<li class="'. $spans .'">';
					...
					// post category
                                        ...
                                        if ($type!='' && $type!='post') {
                                                ...
                                                if($categories){
														//$output1 = '<a href="'.get_category_link($category->term_id ).'" title="'.$category->name.'">'.$category->cat_name.'</a> ';
                                                        $out = array();
                                                        //$output .= '<em>Posted in </em>';
					...
					$output1 .= '<h5><a href="'.get_permalink($post_id).'" title="'.get_the_title($post_id).'">';
					$output1 .= get_the_title($post_id);
					$output1 .= '</a></h5>';

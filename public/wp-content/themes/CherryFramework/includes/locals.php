<?php
	function theme_locals($label) {
		...
		$locals = array(
			...
			'sorry' => __('N&atilde;o foi possivel encontrar o arquivo.', $domain),
			'not_exist' => __('N&atilde;o foi possivel encontrar o arquivo', $domain),
			'please' => __('Por favor', $domain),
			...
			'default_read_more' => __('(default: "Leia mais")', $domain),
			...
			'there_has' => __('N&atilde;o foi poss&iacute;vel encontrar o arquivo.', $domain),
			'we_apologize' => __('', $domain),
			'return_to' => __('', $domain),
			'search_form' => __('Fa&ccedil;a a busca novamente.', $domain),
			...
			//title.php
			'category_archives' => __('&Uacute;ltimas', $domain),

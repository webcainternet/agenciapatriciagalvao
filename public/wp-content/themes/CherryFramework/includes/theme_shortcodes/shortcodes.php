<?php
//Recent Posts1
if (!function_exists('shortcode_recent_posts1')) {

	function shortcode_recent_posts1($atts, $content = null) {
...
$category = 'mulher-midia-zika';
	...
	add_shortcode('recent_posts1', 'shortcode_recent_posts1');
}

...
if ( !function_exists( 'pagination' ) ) {
	function pagination($pages = '', $range = 1) { 
		...
		if(1 != $pages) {
			...
			if($paged > 2 && $paged > $range+1 && $showitems < $pages) echo "<li class='first'><a href='".get_pagenum_link(1)."'>Primeira</a></li>";
			if($paged > 1 && $showitems < $pages) echo "<li class='prev'><a href='".get_pagenum_link($paged - 1)."'>Anterior</a></li>";
			...
			if ($paged < $pages && $showitems < $pages) echo "<li class='next'><a href=\"".get_pagenum_link($paged + 1)."\">Pr&oacute;xima</a></li>"; 
			if ($paged < $pages-1 &&  $paged+$range-1 < $pages && $showitems < $pages) echo "<li class='last'><a href='".get_pagenum_link($pages)."'>&Uacute;ltima</a></li>";
			echo "</ul></div>\n";
		}
	}
}

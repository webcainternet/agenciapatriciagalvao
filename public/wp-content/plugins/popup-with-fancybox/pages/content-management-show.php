...
<div class="wrap">
  <div id="icon-edit" class="icon32 icon32-posts-post"></div>
	...
	<?php
	  ...
	  <div class="tablenav">
	  <h2>
	  <a class="button add-new-h2" href="<?php echo POPUPWFB_ADMIN_URL; ?>&amp;ac=add"><?php _e('Add New', 'popup-with-fancybox'); ?></a>
	  <a class="button add-new-h2" href="<?php echo POPUPWFB_ADMIN_URL; ?>&amp;ac=set"><?php _e('Popup Setting', 'popup-with-fancybox'); ?></a>
	  <a class="button add-new-h2" target="_blank" href="<?php echo Popupwfb_FAV; ?>"><?php _e('Help', 'popup-with-fancybox'); ?></a>
	  </h2>
	  </div>
	  <div style="height:5px"></div>
	<h3><?php _e('Plugin configuration option', 'popup-with-fancybox'); ?></h3>
	<ol>
		<li><?php _e('Drag and drop the widget (Display entire website)', 'popup-with-fancybox'); ?>.</li>
		<li><?php _e('Add popup into specific  post or page using short code', 'popup-with-fancybox'); ?></li>
		<li><?php _e('Add directly in to the theme using PHP code', 'popup-with-fancybox'); ?></li>
	</ol>
	<p class="description">

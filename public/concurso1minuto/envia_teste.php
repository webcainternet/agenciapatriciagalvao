<?php
//$emailremetente    = 'agencia@patriciagalvao.org.br';
...
if (eregi('tempsite.ws$|locaweb.com.br$|hospedagemdesites.ws$|websiteseguro.com$', $_SERVER[HTTP_HOST])) {
        $emailsender='romanoterra@gmail.com';
} else {
        $emailsender = "agencia@patriciagalvao.org.br" . $_SERVER[HTTP_HOST];
...
//$emailremetente    = trim($_POST['agencia@patriciagalvao.org.br']);
